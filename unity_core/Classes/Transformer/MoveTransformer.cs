...
public class MoveTransformer : Transformer 
{
    ...
    /// <param name="time">变换时长</param>
    /// <returns></returns>
    public static MoveTransformer moveBy(GameObject target, float relative_x, float relative_y, float time)
    {
    ...
    /// <param name="time">变换时长</param>
    /// <returns></returns>
    public static MoveTransformer moveSpeed(GameObject target, float speedX, float speedY, float time)
    {
        MoveTransformer transformer = new MoveTransformer();
